        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.elections.store') }}" class="mt-6 space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <select id="category" name="category"
                                ...
                                required>
                                <option value="guild_president" {{ old('category') == 'guild_president' ? 'selected' : '' }}>Guild President</option>
                                <option value="faculty_representative" {{ old('category') == 'faculty_representative' ? 'selected' : '' }}>Faculty Representative</option>
                            </select>
                        ...
                        <div class="flex items-center gap-4">
                            <x-primary-button
                                style="background-color: #8B0000;">{{ __('Save Election') }}</x-primary-button>
                            <a href="{{ route('admin.elections.index') }}"
