        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.candidates.store') }}" class="mt-6 space-y-6"
                        ...
                        <div>
                            ...
                            <select id="election_id" name="election_id"
                                ...
                                required>
                                <option value="">-- Select Active Registry --</option>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="candidate_number" name="candidate_number" type="text"
                                    class="mt-1 block w-full" :value="old('candidate_number')" required
                        ...
                        <div>
                            ...
                            <textarea id="bio" name="bio"
                                ...
                                rows="4"
                                placeholder="Brief statement about the candidate's vision...">{{ old('bio') }}</textarea>
                            <x-input-error class="mt-2" :messages="$errors->get('bio')" />
                        </div>

                        <div>
                            <x-input-label for="photo" :value="__('Official Portrait (Image Upload)')" />
                            <div
                                class="mt-1 flex items-center justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md hover:border-red-400 transition-colors">
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        <label for="photo"
                                            class="relative cursor-pointer bg-white rounded-md font-black text-iuea-red hover:text-red-700 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-red-500">
                        ...
                        <div class="flex items-center gap-4">
                            <x-primary-button
                                style="background-color: #8B0000;">{{ __('Save Candidate') }}</x-primary-button>
                            <a href="{{ route('admin.candidates.index') }}"
