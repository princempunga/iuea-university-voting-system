...
@php
    $classes = ($active ?? false)
        ? 'inline-flex items-center px-1 pt-1 border-b-2 border-dark-red text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-red-900 transition duration-150 ease-in-out'
